...
def _blackbars_filter(mode: str, height: int, timings: list[tuple[int, int]]) -> str:
    ...
    if mode == "bars169":
        ...
        # The plain 16:9 option never crops or stretches. It scales to the
        # requested height and therefore adds no intentional padding.
        vf = "scale=w=-2:h={}:force_original_aspect_ratio=decrease".format(height)
